...
class Config:
    SECRET_KEY = os.envrion.get('SECRET_KEY') or 'hard to guess string'  # 密钥
    ...
    FLASKY_ADMIN = os.envrion.get('FLASK_ADMIN')  # 收件管理员
...
class DevelopmentConfig(Config):
    ...
    MAIL_PORT = 587
    MAIL_USER_TLS = True
    MAIL_USERNAME = os.envrion.get('MAIL_USERNAME')
